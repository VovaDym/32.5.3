...
PROTOBUF_CONSTEXPR Organization::Organization(
  ...
  , /*decltype(_impl_.externaleconomy_)*/false} {}
...
const uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Organization, _impl_.foundationyear_),
  PROTOBUF_FIELD_OFFSET(::Organization, _impl_.address_),
  PROTOBUF_FIELD_OFFSET(::Organization, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::Organization, _impl_.occupation_),
  PROTOBUF_FIELD_OFFSET(::Organization, _impl_.externaleconomy_),
  3,
  0,
  1,
  2,
...
Organization::Organization(const Organization& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.externaleconomy_){}};
  ...
  ::memcpy(&_impl_.foundationyear_, &from._impl_.foundationyear_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.externaleconomy_) -
    reinterpret_cast<char*>(&_impl_.foundationyear_)) + sizeof(_impl_.externaleconomy_));
...
// @@protoc_insertion_point(message_clear_start:Organization)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.foundationyear_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.externaleconomy_) -
        reinterpret_cast<char*>(&_impl_.foundationyear_)) + sizeof(_impl_.externaleconomy_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "Organization.address");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "Organization.name");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "Organization.occupation");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          _impl_.externaleconomy_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Organization::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_externaleconomy(), target);
  }
...
void Organization::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.externaleconomy_ = from._impl_.externaleconomy_;
    }
...
void Organization::InternalSwap(Organization* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Organization, _impl_.externaleconomy_)
      + sizeof(Organization::_impl_.externaleconomy_)
      - PROTOBUF_FIELD_OFFSET(Organization, _impl_.foundationyear_)>(
...
template<> PROTOBUF_NOINLINE ::Organization*
Arena::CreateMaybeMessage< ::Organization >(Arena* arena) {
